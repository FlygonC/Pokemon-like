...
static public class GameData {
    ...
    static public void LoadSpecies()
    {
        ...
        speciesIndex.Add(SpeciesEnum.Aquamaea,      new Species("Aquamaea",     Util.DefType(ElementTypes.Water),       new CreatureStats(100, 100, 90, 110, 80, 90, 90),       new Ability[1] { new FastHealer() }));
        ...
        speciesIndex.Add(SpeciesEnum.Shockmaea,     new Species("Shockmaea",    Util.DefType(ElementTypes.Electric),    new CreatureStats(85, 120, 100, 100, 85, 85, 125),      new Ability[2] { new MagField(), new Battery() }));
    ...
    static public void LoadAttacks()
    {
        ...
        attacksIndex.Add(AttackEnum.Gust,       new Gust());
        attacksIndex.Add(AttackEnum.Absorb,     new Absorb());
        attacksIndex.Add(AttackEnum.AuraBlast, new AuraBlast());
        attacksIndex.Add(AttackEnum.Sting,      new Sting());
        attacksIndex.Add(AttackEnum.RockThrow, new RockThrow());
    }
}
